...
console.log('<div data-bind-content="name"></div>'.bind('', {name: 'Elena'}));
console.log('<a data-bind-content="name" data-bind-href="link" data-bind-class="name"></a>'
		.bind('', {name: 'Elena', link: 'http://telerikacademy.com'}));
